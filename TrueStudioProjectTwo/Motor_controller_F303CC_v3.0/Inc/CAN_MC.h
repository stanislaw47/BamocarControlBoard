...
CanTxMsgTypeDef TxMessageBufor;
...
void CAN_MC_CyclicDataDisable(void);//tuurns off cyclic data sending by Bamcoar
...
void CAN_MC_SendRTD(uint8_t RTD); //send RTD data to RTD Sound
